(function () {
    ...
    const config = {
        ...
        botpressConfigUrl: 'https://crystal-agent.pages.dev/Orenda.js',
    ...
    let webhookSent = false;(function () {
    'use strict';

    // Configuration
    const config = {
        botpressWebchatUrl: 'inject_full_screen.js',
        botpressConfigUrl: 'HASA.js',
